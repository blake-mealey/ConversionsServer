...
namespace Chimerical.Conversions.Db.Migrations
{
    ...
    [Migration("20181013201638_Astronomical")]
    partial class Astronomical
    {
            ...
            modelBuilder.Entity("Chimerical.Conversions.Db.Models.Conversions.Conversion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { FromUnitSymbol = "au", ToUnitSymbol = "m", Multiplier = 149597870700.0 },
                        new { FromUnitSymbol = "pc", ToUnitSymbol = "au", Multiplier = 206265.0 },
                        new { FromUnitSymbol = "pc", ToUnitSymbol = "ly", Multiplier = 3.2616 }
                    );
                });
            ...
            modelBuilder.Entity("Chimerical.Conversions.Db.Models.Conversions.Unit", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Symbol = "pc", DisplayName = "Parsec" },
                        new { Symbol = "ly", DisplayName = "LightYear" },
                        new { Symbol = "au", DisplayName = "AstronomicalUnit" }
                    );
                });
            ...
            modelBuilder.Entity("Chimerical.Conversions.Db.Models.Conversions.UnitType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 15, DisplayName = "Astronomical" }
                    );
                });
